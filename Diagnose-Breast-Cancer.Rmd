...
Each mammogram screening includes the following features:
  ...
  + Hispanic: Classification if a patient is Hispanic.
  ...
  + Cancer: Diagnosis of invasive or ductal carcinoma within a year of index screening mammogram.
...
```{r}
fit2 = rpart(cancerAsFactor ~ age.group + breast.density + relatives.with.bc + invasive.bc, data = tr_dat, method="class")
